...

    {
      description:
        <div className="abilityDescription">
          ...
          <p className="stat--ap">Pre-mitigation:
            <span className="stat--vamp">{' '}{Math.round(((30)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)))}</span> - 
            {' '}<span className="stat--mana">{Math.round(((40)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)))}</span> - 
            {' '}<span className="stat--armor">{Math.round(((15)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)))}</span> /

            <span className="stat--vamp">{' '}{Math.round(((50)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)))}</span> - 
            {' '}<span className="stat--mana">{Math.round(((65)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)))}</span> - 
            {' '}<span className="stat--armor">{Math.round(((25)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)))}</span> /

             <span className="stat--vamp">{' '}{Math.round(((70)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)))}</span> - 
             {' '}<span className="stat--mana">{Math.round(((90)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)))}</span> - 
             {' '}<span className="stat--armor">{Math.round(((35)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)))}</span> /

             <span className="stat--vamp">{' '}{Math.round(((90)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)))}</span> - 
             {' '}<span className="stat--mana">{Math.round(((115)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)))}</span> - 
             {' '}<span className="stat--armor">{Math.round(((45)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)))}</span>             
          </p>

          <p className="stat--ap">Post-mitigation: 
            <span className="stat--vamp">{' '}{Math.round(((30)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> - 
            {' '}<span className="stat--mana">{Math.round(((40)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> -
            {' '}<span className="stat--armor">{Math.round(((15)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> / 

            <span className="stat--vamp">{' '}{Math.round(((50)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> - 
            {' '}<span className="stat--mana">{Math.round(((65)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> -
            {' '}<span className="stat--armor">{Math.round(((25)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> /

            <span className="stat--vamp">{' '}{Math.round(((70)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> - 
            {' '} <span className="stat--mana">{Math.round(((90)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> -
            {' '}<span className="stat--armor">{Math.round(((35)+(atk.ap * 50 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> /

            <span className="stat--vamp">{' '}{Math.round(((90)+(atk.ap * 60 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> - 
            {' '}<span className="stat--mana">{Math.round(((115)+(atk.ap * 75 / 100)+(atk.attack * 100 / 100)) * (1 - mod.defMagRed))}</span> -
          ...
          <p>
            <b className="stat--vamp">Red Cards:</b> deal <span className="stat--ap">30 / 50 / 70 / 90 (+60% AP) (<span className="stat--ad">+100% AD</span>) magic damage</span> in an area and <span className="stat--moveSpeed">slow by 35/40/45/50%</span> for 3 seconds.
          </p>

          <p>
            <b className="stat--mana">Blue Cards:</b> deal <span className="stat--ap">40 / 65 / 90 / 115 (+75% AP) (<span className="stat--ad">+100% AD</span>) magic damage</span> and and restore <span className="stat--mana">60/90/120/150 Mana</span>.
          </p>
      ...
      description:
        <div className="abilityDescription">
          ...
          <p className="stat--ap">Post-mitigation: 
            ...
            {' '}{Math.round(((110)+(atk.ap * 45 / 100))* (1 - mod.defMagRed))} / 
          ...
          <br />
          <p>
           <b>Passive:</b> gain <span className="stat--as">15 / 20 /  25 / 30% Attack Speed.</span>. Every 4th attack deals <span className="stat--ap">50 / 80 / 110 / 150 (+45% AP) bonus magic damage</span> 
          </p>

          <p>
            <b>Active:</b> gain <span className="stat--as">30% ({(champ.asBase * 30 / 100).toFixed(3)}) / 35% ({(champ.asBase * 35 / 100).toFixed(3)}) / 40% ({(champ.asBase * 40 / 100).toFixed(3)}) / 45% ({(champ.asBase * 45 / 100).toFixed(3)}) Attack Speed</span> for 3 seconds. During this time, attacking enemy champions rolls <b>Loaded Dice</b>.
          </p>
        </div>
    },
